...
type linuxExecutionBackend struct{}

func currentExecutionBackend() executionBackend { return linuxExecutionBackend{} }

func (linuxExecutionBackend) isAbsolutePath(value string) bool {
	return filepath.IsAbs(value)
}

func (linuxExecutionBackend) validateWorkingDirectory(value string) (string, error) {
	return validateWorkingDirectory(value)
}

func (linuxExecutionBackend) startExec(ctx context.Context, channel ssh.Channel, command, cwd string) (sessionProcess, error) {
	return startExec(ctx, channel, command, cwd)
}

func (linuxExecutionBackend) startShell(ctx context.Context, channel ssh.Channel, request *ptyState, cwd string) (sessionProcess, error) {
	return startShell(ctx, channel, request, cwd)
}
...
func (process *process) signalRequest(request processSignal) error {
...
func (process *process) doneChannel() <-chan struct{} {
	return process.done
}
