...
func TestDispatcherExactPathShapes(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "/api/v1/agent-sessions/ags_one/models", want: "agent"},
		{path: "/api/v1/agent-sessions/ags_one/unknown", want: "browser"},
		{path: "/api/v1/agent-runtimes/dsh/providers", want: "agent"},
		{path: "/api/v1/agent-runtimes/dsh/providers/deepseek-official", want: "agent"},
		{path: "/api/v1/agent-runtimes//providers", want: "browser"},
		{path: "/api/v1/agent-runtimes/dsh/providers/", want: "browser"},
		{path: "/api/v1/agent-runtimes/dsh/providers/deepseek-official/extra", want: "browser"},
