.PHONY: build build-server build-client test test-race run run-client web-install web-test web-build compose-config docker-build client-artifact client-appimage
